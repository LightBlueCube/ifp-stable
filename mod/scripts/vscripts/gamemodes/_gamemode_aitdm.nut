...
void function GamemodeAITdm_Init()
{
	...
	AddCallback_OnPlayerRespawned( GiveFreeBatteryWhenFirstSpawn )
...
array<entity> function RandomArrayElem( array<entity> a )
{
	array<entity> b = a
	array<entity> c = []
	while( b.len() > 0 )
	{
		entity randElem = b[ RandomInt( b.len() ) ]
